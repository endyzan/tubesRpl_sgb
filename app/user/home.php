            ...
            <div class="content">
                ...
                <div class="SGBGame_cart">
                    <div class="wraper_Foto1">
                        <div class="Foto1">
                            <img src="foto/SGBGame_1.jpg" alt="Foto1">
                        </div>
                    </div>
                    <div class="wraper_Foto2_3">
                        <div class="Foto2">
                            <img src="foto/odong-odong.jpg" alt="Foto2">
                            <div class="button_booking">
                                <p>BELI TIKET SEKARANG</p>
                            </div>
                        </div>
                        <div class="Foto3">
                            <img src="foto/SGBGame_3.jpg" alt="Foto3">
                ...
                <div class="PopularRides_cart">
                    <div class="Foto_PR">
                        <img src="foto/mobil_Listrik.jpg" alt="Foto1">
                        <div class="Game_Mobil">
                            <p>MOBIL LISTRIK</p>
                        </div>
                    </div>
                    <div class="Foto_PR">
                        <img src="foto/lukis.jpg" alt="Foto2">
                    ...
                    <div class="wrapper_CU">
                        <div class="wrapper_definitionSGB">
                            <div class="definitionSGB">
                                <p>
                                    Stadion Gelora Bangkalan dibangun pada tahun 2012 terletak di Jalan
                                    Soekarno-Hatta. Stadion ini beroperasi pada sore hingga malam hari.
                                    Stadion ini menggabungkan konsep pusat makanan rakyat dan permainan
                                    hiburan di dalamnya.
                                </p>
                            </div>
                        </div>
                        <div class="wrapper_about">
                            <div class="about">
                                ...
                                <p>
                                    Jl. Soekarno Hatta, Wr 08, Mlajah, BangkalanKabupaten Bangkalan, Jawa
                                    Timur 69116 Indonesia
                                </p>
                ...
                <div class="footer" id="footer">
                    <p>&copy; Copyright 2023 | Created By DPW2022-2-B05</p>
                </div>
            </div>
        </div>
    </body>
